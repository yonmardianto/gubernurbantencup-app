            ...
            <div class="row row-cards">
                ...
                <div class="col-md-12 col-xl-8 ms-auto me-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="form-admin" method="post" action="{{ route('admin.admins.update', $admin->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            placeholder="Masukkan email admin" name="email"
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <small class="form-hint">Password minimal 8 karakter. Kosongkan untuk tidak mengubah
                                            password.</small>
