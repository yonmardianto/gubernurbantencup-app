...
@section('content')
    <form name="form-daftar" method="post" enctype="multipart/form-data" action="{{ route('manager-team.participants.update', $participant->id) }}">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-xl-12 col-sm-12 wow fadeInUp">
                <div class="wsus__dash_earning">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="required mb-2">
                                ...
                                <input name="nama_lengkap" id="nama_lengkap" type="text" placeholder="Nama lengkap"
                                    class="form-control" value="{{ (isset($participant) && !empty($participant->nama_lengkap)) ? $participant->nama_lengkap : old('nama_lengkap') }}">
                        ...
                        <div class="col-xl-12">
                            <div class="required  mb-2">
                                ...
                                <input class="form-control" name="club" id="club" type="text" placeholder="Club"
                                    value="{{ auth()->user()->club }}" readonly style="background-color: #dfe6e9; !important;">
                        ...
                        <div class="col-xl-12">
                            <div class="required mb-2">
                                ...
                                <select name="kategori_tanding" class="form-control select2" id="kategori_tanding">
                                    <option selected value="">Pilih</option>
                                    <option value="POOMSAE" {{ (isset($participant) && ($participant->kategori_tanding === 'POOMSAE')) ? 'selected' : '' }}>POOMSAE</option>
                                    <option value="KYORUGI" {{ (isset($participant) && ($participant->kategori_tanding === 'KYORUGI')) ? 'selected' : '' }}>KYORUGI</option>
                                </select>
                            ...
                            <div class="col-xl-12">
                                <div class="wsus__login_form_input">
                                    ...
                                    <select name="kelompok_poomsae" class="form-control select2" id="kelompok_poomsae">
                                        <option selected value="">Pilih</option>
                                        <option value="Individu-Putra" {{ (isset($participant) && ($participant->kelompok_poomsae === 'Individu-Putra')) ? 'selected' : '' }}>Individu Putra</option>
                                        <option value="Individu-Putri" {{ (isset($participant) && ($participant->kelompok_poomsae === 'Individu-Putri')) ? 'selected' : '' }}>Individu Putri</option>
                                        <option value="Pair" {{ (isset($participant) && ($participant->kelompok_poomsae === 'Pair')) ? 'selected' : '' }}>Pair</option>
                                        <option value="Beregu" {{ (isset($participant) && ($participant->kelompok_poomsae === 'Beregu')) ? 'selected' : '' }}>Beregu</option>
                                    </select>
                            ...
                            <div class="col-xl-12 div-sabuk-poomsae">
                                <div class="wsus__login_form_input">
                                    ...
                                    <select name="sabuk_poomsae" class="form-control select2" id="sabuk_poomsae">
                                        <option selected value="">Pilih</option>
                                        <option value="KUNING/KUNING-STRIP" {{ (isset($participant) && ($participant->sabuk_poomsae === 'KUNING/KUNING-STRIP')) ? 'selected' : '' }}>KUNING/KUNING STRIP</option>
                                        <option value="HIJAU/HIJAU-STRIP" {{ (isset($participant) && ($participant->sabuk_poomsae === 'HIJAU/HIJAU-STRIP')) ? 'selected' : '' }}>HIJAU/HIJAU STRIP</option>
                                        <option value="BIRU/MERAH" {{ (isset($participant) && ($participant->sabuk_poomsae === 'BIRU/MERAH')) ? 'selected' : '' }}>BIRU/MERAH</option>
                                    </select>
                        ...
                        <div id="sectionKyorugi" class="{{ $participant->kategori_tanding === 'POOMSAE' ?  ' d-none' : ''}}">
                            ...
                            <div class="col-xl-12">
                                <div class="wsus__login_form_input">
                                    ...
                                    <select name="berat_badan" class="form-control select2" id="berat_badan">
                                        <option value="{{ $participant->berat_badan }} KG" selected>{{ $participant->berat_badan }} KG</option>
                                    </select>
                        ...
                        <div class="col-xl-12">
                            <div class="wsus__login_form_input">
                                ...
                                @if(count($documents) > 0)
                                    ...
                                    <a class="venobox" href="{{ url('/'.$item->path) }}"> <img src="{{ url('/'.$item->path) }}" class="mt-3" style="width: 150px !important; height: 100px !important;" /> </a>
                                    @endforeach
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="wsus__login_form_input">
                                <button type="submit" class="btn btn-primary text-white rounded-md"><i class="fas fa-save"></i>
                                    Update
                                    </button>
                            </div>
